...
Dessa forma, foi criado 2 (duas) branches para a comparação de desempenho do sistema, no qual na "main" foi utilizado árvores rubro negras, enquanto na no-tree foi utilizada listas normais.
